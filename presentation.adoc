...
.Domain Driven Desing _Style_
[source,kotlin]
----
data class Grading(val value:String)
data class SpecialGrading1(val value:String)
data class SpecialGrading2(val value:String)

data class ComplexSize(
    val grading: Grading, 
    val specialGrading1: SpecialGrading1? = null, 
    val specialGrading2: SpecialGrading2? = null)
----

=== One more AWESOME thing 🤩

.Jeu de donnée en test 😤
[source,kotlin]
----
val size1 = ComplexSize(
    grading = Grading("38"),
    specialGrading1 = SpecialGrading1("M")  
)

val size2 = ComplexSize(
    grading = Grading("40"),
    specialGrading1 = SpecialGrading1("S"),
    specialGrading2 = SpecialGrading2("30")  
)

val size3 = ComplexSize(
    grading = Grading("42"),
    specialGrading2 = SpecialGrading2("40")  
)
----
...
fun String.toSize() :Size {
    ...
    return when {
        parts.size == 1 -> 
            Size(Grading(s[0]))
        parts.size == 2 -> 
            Size(Grading(s[0]), SpecialGrading1(s[1]), null)
        parts.size == 3 -> 
            Size(
                Grading(s[0]), 
                if (s[1].length == 0) null else SpecialGrading1(s[1]), 
                SpecialGrading2(s[2]))
